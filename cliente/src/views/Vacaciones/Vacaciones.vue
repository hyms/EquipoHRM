                    ...
                    <template v-slot:cell(fecha_fin)="data">
                      <span>{{ data.value | formatDateOnly }}</span>
                        ...
                        <template v-slot:cell(estado)="row">
                            ...
                            <span v-else>{{
                        row.item.estado | formatStateLeave
                      }}</span>
                        </template>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            visibleSelect() {
                return Helpers.visible("vacaciones", 0);
            },
            visibleNuevo() {
                return Helpers.visible("vacaciones", 1);
            },
            visibleEditar() {
                return Helpers.visible("vacaciones", 2);
            },
            visibleEliminar() {
                return Helpers.visible("vacaciones", 3);
            },
            set_message(value) {
