                    ...
                    <div class="padded-lg">
                        ...
                        <div class="element-wrapper">
                            <div class="element-actions">
                                ...
                                <b-modal
                                        id="modal"
                                        :title="formTitle + ' Tipo Vacacion/Permiso'"
                                        @hidden="resetForm"
                                        @ok="handleOk"
                                        okTitle="Guardar"
...
<script>
    ...
    export default {
        data() {
            return {
                pageTitle: "Tipo de Vacaciones/Permisos",
                formTitle: "",
                path: "/api/vacaciones/tipo",
                isBusy: false,
                columns: ["tipo", "tiempo_dias", "Acciones"],
                tables: [],
                validator: [],
                model: {
                    tipo: "",
            ...
            async resetForm() {
                ...
                this.schema["fields"] = [
                    ...
                    },
                    {
                        type: "input",
                        inputType: "numeric",
                        label: "Tiempo de dias",
                        model: "tiempo_dias",
                        attributes: {placeholder: "Tiempo de dias"}
                    }
                ];
