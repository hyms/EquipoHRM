        ...
        schema: {
          fields: [
            ...
            },
            {
              ...
              disabled: this.disabled,
              selectOptions: {noneSelectedText: "Selecciona una Unidad de Negocio"},
              values: []
            },
            {
              type: "select",
              ...
              model: "area_trabajo",
              disabled: this.disabled,
              selectOptions: {noneSelectedText: "Selecciona un Area de Trabajo"},
              values: []
            },
            {
              type: "select",
            ...
            },
            {
              ...
              model: "tipo_empleado",
              disabled: this.disabled,
              selectOptions: {noneSelectedText: "Selecciona el tipo de Empleado"},
